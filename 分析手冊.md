...
本手冊說明實機測試時，每一份報告（`apps/<中文名稱>.md`）需要蒐集哪些資訊、如何判定與填寫。範本以完整的 [行動自然人憑證](apps/行動自然人憑證.md) 報告為準。
...
| App | 檔案 | 狀態 |
|-----|------|------|
| 行動自然人憑證 | `apps/行動自然人憑證.md` | ✅ 完成（範本） |
| 警政服務 | `apps/警政服務.md` | ✅ 完成 |
| 健保快易通 | `apps/健保快易通.md` | ✅ 完成 |
| 郵局（中華郵政） | `apps/郵局.md` | ✅ 完成 |
| 台灣行動支付（台灣Pay） | `apps/台灣Pay.md` | ✅ 完成 |
| LINE | `apps/LINE.md` | ✅ 完成 |
| Google 地圖 | `apps/Google地圖.md` | ✅ 完成 |
| 台鐵e訂通 | `apps/台鐵e訂通.md` | ✅ 完成 |
| 蝦皮購物 | `apps/蝦皮購物.md` | ✅ 完成 |
